  ...
  return (
    <section className="contact-form mt-5">
      <div className="container">
        ...
        {submitted ? (<AlertNotification alertType="succses" title="Thank you for your comments!" text="We will contact you as soon as possible." />) : (<></>)}
        {failedSubmit ? (<AlertNotification alertType="danger" title="Somting went wrong!" text="Couldn't submit your comments rigt now." />) : (<></>)}
